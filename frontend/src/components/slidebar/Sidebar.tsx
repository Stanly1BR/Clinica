            ...
            <aside className={`fixed top-0 left-0 z-50 w-[280px] h-screen bg-zinc-950 border-r border-zinc-900 flex flex-col justify-between transition-transform duration-300 ease-in-out ${
                ...
                <div className="p-6">
                    ...
                    <nav className="space-y-2 w-full">
                        <a href="#" className="flex items-center gap-3 px-4 py-3 text-zinc-300 hover:text-white bg-zinc-900/0 hover:bg-zinc-900/40 rounded-lg transition-all group w-full border border-transparent hover:border-zinc-800">
